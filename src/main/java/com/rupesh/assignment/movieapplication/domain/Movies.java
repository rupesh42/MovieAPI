...
public class Movies {
	...
	public Movies(Integer id, String additionalInfo, String movieyear, String nominee, BigDecimal boxOffice,
	...
	public String toString() {
		return "Movies [id=" + id + ", additionalInfo=" + additionalInfo + ", movieyear=" + movieyear
